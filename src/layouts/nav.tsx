...
export default function Nav() {
  ...
  return (
    <div className="md:grid-cols-7 md:grid bg-blue-950  md:h-24  md:items-center md:justify-center fixed md:w-full z-10 flex flex-col-reverse items-start w-full ">
      ...
      <div className={navHidden?"hidden":"block"+"nav-content md:col-span-3 md:flex md:flex-row p-2 flex flex-col md:order-2 w-full"}>
        <div className="dropdown group md:basis-1/4 order-3 md:order-1">
          ...
          <div className="dropdown-content text-sm hidden group-hover:block text-white absolute bg-blue-950 py-2 px-4 border border-x-zinc-50 md:ml-6 ml-0  ">
        ...
        <div className="dropdown group md:basis-1/4 order-2 md:order-2">
          ...
          <div className="dropdown-content text-sm hidden group-hover:block text-white absolute bg-blue-950 p-2 border border-x-zinc-50 ml-0 md:ml-6">
            <div className="w-96 md:w-48  px-1 py-2 flex flex-col items-start">
              <p className="underline  font-semibold hover:text-blue-400">
                Overview
              </p>
      ...
      <div className={navHidden?"hidden":"block"+"nav-contact md:col-span-2 md:flex md:items-center md:justify-center mt-2 pl-1 md:order-3"}>
        <button className="px-2 py-1 text-blue-900 rounded-md font-semibold hover:bg-cyan-300 md:text-blue-950 md:hover:text-white bg-white ">Contact us</button>
      </div>
    </div>
  );
}